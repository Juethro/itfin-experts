        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="inner pt--80 text-center" data-sal="slide-up" data-sal-duration="400" data-sal-delay="150">
                    <div>
                        <h3 class="rainbow-sub-badge"><span class="theme-gradient">Tentang Perusahaan Kami
                        Detail.</span></h3>
                    </div>
                    <h1 class="title display-one">Kami adalah Agensi Bisnis <br> Korporat</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="service-area rainbow-section-gapTop">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="content">
                    <h3 class="title">Kenali Lebih Dekat Perusahaan Kami</h3>
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="row row--0">
                        <div class="col-lg-3 col-md-3 rainbow-timeline-single no-gradient">
                            <div class="rainbow-timeline">
                                <h6 class="title" data-sal="slide-up" data-sal-duration="400" data-sal-delay="200">Initiation</h6>
...
<div class="rainbow-team-area rainbow-section-gap">
    <div class="container">
        <div class="row mb--20">
            <div class="col-lg-12">
                <div class="section-title text-center" data-sal="slide-up" data-sal-duration="400" data-sal-delay="150">
                    <h4 class="subtitle "><span class="theme-gradient">Tim Kami.</span></h4>
                    <h2 class="title w-600 mb--20">Tim Profesional Kami.</h2>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6 col-xl-3 col-md-6 col-12 mt--30" data-sal="slide-up" data-sal-duration="400" data-sal-delay="150">
                <div class="rainbow-team team-style-three">
                    <div class="inner">
                        ...
                        <div class="content">
                            <div class="team-info">
                                <h2 class="title">Andias</h2>
                                <h6 class="subtitle theme-gradient">CEO</h6>
