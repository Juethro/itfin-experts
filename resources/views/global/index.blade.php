...
<div class="slider-area slider-style-1 variation-default height-850 bg_image bg_image--3" data-black-overlay="7">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="inner text-center"><span class="subtitle">Professional IT Consulting</span>
        ...
        <div class="row row--15 service-wrapper">
            <div class="col-lg-12">
                <div class="section-title text-center" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">
                    <h4 class="subtitle "><span class="theme-gradient">Good Service</span></h4>
                    <h2 class="title w-600 mb--20">Our Service</h2>
                    <p class="description b1">We provide technology and finance service for <br> startups and
                        company.</p>
                </div>
            </div>
                                ...
                                <div class="row row--30 align-items-center">
                                    <div class="col-lg-6 mt_md--40 mt_sm--40 order-2 order-lg-1">
                                        <div class="content">
                                            ...
                                            <h2 class="title" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">Schedule a Consultation Session.</h2>
                                            <p class="description" data-sal="slide-up" data-sal-duration="700" data-sal-delay="200">You can schedule an initial
                                                consultation session with our team to understand your business’s technology needs.</p>
                                            ...
                                            <div class="read-morebtn" data-sal="slide-up" data-sal-duration="700" data-sal-delay="300">
                                                <a class="btn-default btn-large round" href="/en/contact"><span>Get Started Now</span></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row row--30 align-items-center">
                                    <div class="col-lg-6 mt_md--40 mt_sm--40 order-2 order-lg-1">
                                        <div class="content">
                                            ...
                                            <h2 class="title" data-sal="slide-up" data-sal-duration="700" data-sal-delay="200">Analysis and Solution Design.
                                            </h2>
                                            <p class="description" data-sal="slide-up" data-sal-duration="700" data-sal-delay="300">We will deeply analyze your
                                                business requirements and craft a tailored IT solution.</p>
                                            <div class="row row--30">
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="working-list">
                                            ...
                                            <div class="read-morebtn" data-sal="slide-up" data-sal-duration="700" data-sal-delay="400">
                                                <a class="btn-default btn-large round" href="/en/contact">
                                ...
                                <div class="row row--30 align-items-center">
                                    <div class="col-lg-6 mt_md--40 mt_sm--40 order-2 order-lg-1">
                                        <div class="content">
                                            ...
                                            <h2 class="title" data-sal="slide-up" data-sal-duration="700" data-sal-delay="200">Roadmap and Timeline Creation.
                                            </h2>
                                            <p class="description" data-sal="slide-up" data-sal-duration="700" data-sal-delay="300">We prepare a project roadmap
                                                and a clear timeline to ensure every step is well-structured.</p>
                                            <div class="row row--30">
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="working-list">
                                                        <h5 class="working-title" data-sal="slide-up" data-sal-duration="700" data-sal-delay="350">Follow
                                ...
                                <div class="row row--30 align-items-center">
                                    <div class="col-lg-6 mt_md--40 mt_sm--40 order-2 order-lg-1">
                                        <div class="content">
                                            ...
                                            <h2 class="title" data-sal="slide-up" data-sal-duration="700" data-sal-delay="200">Development and Implementation.
                                            </h2>
                                            <p class="description" data-sal="slide-up" data-sal-duration="700" data-sal-delay="300">The designed solution will be developed
                                                and implemented by our expert team, ensuring quality and reliability.</p>
                                            <div class="row row--30">
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="working-list">
                                                        <h5 class="working-title" data-sal="slide-up" data-sal-duration="700" data-sal-delay="350">Follow
                                ...
                                <div class="row row--30 align-items-center">
                                    <div class="col-lg-6 mt_md--40 mt_sm--40 order-2 order-lg-1">
                                        <div class="content">
                                            ...
                                            <h2 class="title" data-sal="slide-up" data-sal-duration="700" data-sal-delay="200">Ongoing Support.
                                            </h2>
                                            <p class="description" data-sal="slide-up" data-sal-duration="700" data-sal-delay="300">We provide technical support to ensure
                                                our solutions continue to deliver optimal results for your business.</p>
                                            <div class="row row--30">
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="working-list">
                                                        <h5 class="working-title" data-sal="slide-up" data-sal-duration="700" data-sal-delay="350">Follow
            ...
            <div class="col-lg-7 mt_md--40 mt_sm--40" data-sal="slide-left" data-sal-duration="700">
                <div class="content">
                    <div class="section-title">
                        <h4 class="subtitle "><span class="theme-gradient">You Can Ask Us!
                            </span></h4>
                        ...
                        <div class="accordion" id="accordionExamplea">
                            <div class="accordion-item card">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExamplea">
                                    <div class="accordion-body card-body">
                                        We offer IT consultation, software development, and digital transformation.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item card">
                                <h2 class="accordion-header card-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        How does the collaboration process begin?
                                    </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExamplea">
                                    <div class="accordion-body card-body">
                                        We start by discussing your business needs through an initial consultation.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item card">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExamplea">
                                    <div class="accordion-body card-body">
                                        Yes, our services are tailored to each client’s unique needs.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="inner">
                            <div class="content text-center">
                                <h2 class="title">Ready to work with ITFIN?</h2>
                                <h6 class="subtitle">Contact Us &amp; Schedule Meeting</h6>
                                <div class="call-to-btn">
                                    <a class="btn-default btn-icon" href="/en/contact">Contact Us
